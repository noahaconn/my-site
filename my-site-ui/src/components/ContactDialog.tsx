  ...
  return (
      ...
      {open && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-100">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              >
                ...
                className="cursor-pointer text-gray-500 hover:text-gray-200 w-5"
            ...
            <button
              ...
              className="cursor-pointer mt-2 px-4 py-1 text-sm bg-gray-800 rounded-lg hover:bg-gray-700"
            >
              Close
            </button>
          </div>
          ...
          {/* Copied toast */}
          {copied && (
            <div className="absolute bottom-8 bg-gray-800 text-white text-sm px-3 py-1 rounded-lg shadow">
