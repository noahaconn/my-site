...
export default function Home({ openSide, openConnr }: HomeProps) {
  return (
    <main className={`flex ${openSide ? "ml-64" : ""} ${openConnr ? "mr-90" : ""} min-h-screen w-screen flex-col items-center mt-10 px-4`}>
      <div className="h-40 w-90 p-7 m-15 rounded text-gray-600 dark:text-white bg-gray-200 dark:bg-gray-700">
      ...
      <div className="max-w-2xl text-center">
        ...
        <p className="mb-8 text-lg dark:text-white text-balance">
